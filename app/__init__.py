...
def create_app():
    ...
    from app.routes.doctor_consultation_routes import doctor_consultation_bp
    app.register_blueprint(doctor_consultation_bp)
    ...
    from app.routes.patient_dashboard_routes import patient_dashboard_bp
